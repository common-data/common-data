...
Contamos aqui com alguns dados baixados na pasta data. A maioria das nossas análises do Covid-19 são do banco de dados caso_full.csv da Brasil.io (https://data.brasil.io/dataset/covid19/_meta/list.html). 
